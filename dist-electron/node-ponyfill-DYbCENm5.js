...
import { g as getAugmentedNamespace } from "./main-B8kJvmji.js";
...
const STATUS_CODES = require$$0__default.STATUS_CODES;
class Response {
  constructor() {
...
function fetch(url, opts) {
  ...
  return new fetch.Promise(function(resolve, reject) {
    ...
    const send = (options.protocol === "https:" ? require$$1__default : require$$0__default).request;
